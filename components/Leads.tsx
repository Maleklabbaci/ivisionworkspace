    ...
    <div className="relative">
      <div className="space-y-10 animate-fade-in">
        <div className="flex justify-between items-end px-2">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-orange-400 mb-2">PROSPECT PIPELINE</p>
          ...
          {filteredLeads.map((lead: Lead) => {
            ...
            return (
              <div key={lead.id} onClick={() => { setSelectedLead(lead); setViewMode('view'); }} className="glass-card p-8 rounded-[3rem] border border-white/5 group cursor-pointer relative overflow-hidden">
                ...
                <p className="text-[10px] text-slate-500 font-extrabold uppercase tracking-widest mt-2 truncate">{lead.company || 'Indépendant'}</p>
            ...
            <div className="modal-container">
              <div className="modal-content-glass animate-fade-in">
                 <div className="flex justify-between items-start mb-8 md:mb-10">
                   <div>
                     <h3 className="text-xl md:text-3xl font-extrabold text-white uppercase tracking-tight leading-none">Nouveau Prospect</h3>
                     <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mt-2 md:mt-3">Indexation Pipeline iVISION</p>
                   </div>
                   <button onClick={closeModals} className="w-10 h-10 md:w-12 md:h-12 glass text-slate-500 hover:text-white rounded-xl flex items-center justify-center transition-all flex-shrink-0 active-scale"><X size={20}/></button>
                 </div>
                 
                 <form onSubmit={(e) => { e.preventDefault(); onAddLead(formData); closeModals(); }} className="space-y-4 md:space-y-6">
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                      <div className="space-y-1.5 md:space-y-2">
                         <label className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 px-2 leading-none">Identité Prospect</label>
                      ...
                      <div className="space-y-1.5 md:space-y-2">
                         <label className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 px-2 leading-none">Organisation</label>
                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                      <div className="space-y-1.5 md:space-y-2">
                         <label className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 px-2 flex items-center leading-none"><Mail size={12} className="mr-2 text-orange-400"/> Email Pro</label>
                      ...
                      <div className="space-y-1.5 md:space-y-2">
                         <label className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 px-2 flex items-center leading-none"><Phone size={12} className="mr-2 text-orange-400"/> Ligne Directe</label>
                   ...
                   <div className="grid grid-cols-2 gap-4 md:gap-5 pt-2">
                      <div className="space-y-1.5 md:space-y-2">
                         <label className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 px-2 flex items-center leading-none"><TrendingDown size={12} className="mr-2 text-orange-400"/> Budget Min (DZD)</label>
                      ...
                      <div className="space-y-1.5 md:space-y-2">
                         <label className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 px-2 flex items-center leading-none"><TrendingUp size={12} className="mr-2 text-orange-400"/> Budget Max (DZD)</label>
                   ...
                   <button className="w-full py-5 md:py-6 bg-orange-400 text-slate-950 font-black rounded-2xl md:rounded-3xl shadow-xl active-scale uppercase text-[10px] md:text-[11px] tracking-[0.3em] mt-2 md:mt-4 transition-all hover:bg-orange-300 shadow-orange-500/30">Confirmer Prospect</button>
                 </form>
              </div>
            </div>
          </div>
              ...
              <div className="modal-content-glass animate-fade-in">
                 ...
                 <div className="space-y-6 md:space-y-8">
                    <div className="p-5 md:p-8 bg-slate-900/40 rounded-[1.8rem] md:rounded-[2.5rem] border border-white/5 relative overflow-hidden">
                       <h4 className="text-[9px] md:text-[10px] font-black text-orange-400 uppercase tracking-[0.3em] mb-3 md:mb-4 flex items-center leading-none"><Info size={14} className="mr-2"/> Brief Prospect</h4>
                       <p className="text-[12px] md:text-[14px] text-slate-300 leading-relaxed font-medium">{selectedLead.description || "Aucun brief spécifique."}</p>
                    </div>
