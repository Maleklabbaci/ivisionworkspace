...
const ToastItem: React.FC<{ toast: ToastNotification; onDismiss: (id: string) => void }> = ({ toast, onDismiss }) => {
  ...
  return (
    <div className={`pointer-events-auto bg-white shadow-lg rounded-md border-l-4 ${getBorderColor()} p-4 w-80 transform transition-all animate-in slide-in-from-right duration-300 flex items-start justify-between`}>
